...
<script>
  ...
  <body>
    <?php require '../alumni/alumnav.php' ?>
...
$sql = "insert into alumni(name,roll,email,pass) values('$name','$roll','$email','$pass')";
...
if($result){
	...
	<div class="container mt-5">
		...
		<form action="/psystem/alumni/signup.php" method="post">
			<div class="form-group">
				<label for="name">Name:</label>
				<input type="text" class="form-control" id="name" placeholder="Enter Alumni Name" required name="name">
			</div>
			<div class="form-group">
